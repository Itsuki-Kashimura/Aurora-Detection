...
def main(name_basemodel, num_classes, num_channels_img):
    ...
    train_dataset = ImageDataSet(
        path_to_labels_csv="path-to-df-labels-train.csv", 
        path_to_img_dir="path-to-images-dir",
        crop_size=crop_size
    )
    valid_dataset = ImageDataSet(
        path_to_labels_csv="path-to-df-labels-valid.csv", 
        path_to_img_dir="path-to-images-dir",
        crop_size=crop_size
    )
...
if __name__ == '__main__':
    ...
    main(
        ...
        num_classes=2,       # Number of classes for classification (2 for binary, >2 for multiclass)
